...
const Jonco = () => {
  return (
    <div className='w-full overflow-hidden'>
      <Head>
        <title>Jonco-Met App | Mahmoud Kalekish</title>
        <meta name='description' content='Jonco-Met App – a project by Mahmoud Kalekish, Full-Stack Software Engineer.' />
      ...
      <div className='w-screen h-[50vh] relative overflow-hidden'>
        ...
        <Image
          ...
          src={joncoImg}
          alt='Jonco-Met App project banner'
        />
