...
const need = () => {
  return (
    <div className='w-full overflow-hidden'>
      <Head>
        <title>Need Website | Mahmoud Kalekish</title>
        <meta name='description' content='Need Website – a project by Mahmoud Kalekish, Full-Stack Software Engineer.' />
      ...
      <div className='w-screen h-[50vh] relative overflow-hidden'>
        ...
        <Image
          ...
          src={needImg}
          alt='Need Website project banner'
        />
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h2 className='py-2'>Need Website</h2>
          <h3>ReactJS / Tailwind / Firebase / NodeJS / ExpressJS / MongoDB</h3>
        </div>
      </div>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <a
            href='https://need-website.netlify.app/'
            target='_blank'
            rel='noreferrer'
          >
