...
const Avon = () => {
    return (
      ...
      <Head>
        <title>AVON – E-commerce Website | Mahmoud Kalekish</title>
        <meta name='description' content='AVON – E-commerce Website – a project by Mahmoud Kalekish, Full-Stack Software Engineer.' />
